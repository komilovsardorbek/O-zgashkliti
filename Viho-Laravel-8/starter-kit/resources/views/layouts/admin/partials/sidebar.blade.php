        ...
        <div class="main-navbar">
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="{{route('work')}}" target="_blank"><i data-feather="home"></i><span>Dashboard</span></a>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/starter-kit') }};">
                            <li>
                                <a class="submenu-title {{ in_array(Route::currentRouteName(), ['work','layout-dark']) ? 'active' : '' }}" href="javascript:void(0)">
                                    Color Version<span class="sub-arrow"><i class="fa fa-chevron-right"></i></span>
                                </a>
                                <ul class="nav-sub-childmenu submenu-content" style="display: {{ in_array(Route::currentRouteName(), ['work','layout-dark']) ? 'block' : 'none' }};">
                                    <li><a href="{{route('work')}}"  class="{{routeActive('work')}}">Layout Light</a></li>
